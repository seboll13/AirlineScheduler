...
from code.demand_functions import (
    _compute_base_demand, _get_seasonality_factor,
    _get_first_class_multiplier, _get_business_class_multiplier,
...
class PassengerDemand:
    ...
    def get_economy_class_multiplier(self) -> float:
        ...
        return _get_economy_class_multiplier(
            self.stats['populations'][0:1],
            self.stats['populations'][3],
            self.distance
        )
